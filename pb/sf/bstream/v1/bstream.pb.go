...
type Block struct {
	...
	//   - Partial blocks are not "good enough" to link blocks in bstream's forkdb. There will always be the "real block" in a stream; partial blocks are simply additional data.
...
const file_sf_bstream_v1_bstream_proto_rawDesc = "" +
	...
	"\x04step\x18\x04 \x01(\x0e2\x17.sf.bstream.v1.ForkStepR\x04step\"\xca\x03\n" +
	"\x05Block\x12\x16\n" +
	...
	"\rpartial_index\x18\f \x01(\x05R\fpartialIndex\"\xc2\x01\n" +
	"\tBlockMeta\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x04R\x06number\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tparent_id\x18\x03 \x01(\tR\bparentId\x128\n" +
